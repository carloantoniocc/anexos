...
?> 
var Crtl_btn_Admin = false;
function sc_btn_Admin()
{
    if (scEventControl_active_all()) {
      setTimeout(function() { sc_btn_Admin(); }, 500);
      return;
    }
    if (Crtl_btn_Admin) {return;}
    Crtl_btn_Admin = true;
    document.F1.nmgp_parms.value = "nmgp_opcao?#?formphp?@?nm_call_php?#?Admin?@?";
    document.F1.action = "form_usuarios.php";
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_usuarios_submit_form(y, z); 
} 
<?php
}
?>
