<form name="F2" method=post 
               ...
               target="_self"> 
<input type="hidden" name="id_est_" value="<?php echo $this->form_encode_input($this->nmgp_dados_form['id_est_']); ?>">
...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_estado_inline']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
  <input type="hidden" name="script_case_session" value="<?php echo $this->form_encode_input(session_id()); ?>"> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_estado_inline"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  ...
  {
?>  
  if (parent && parent.nmsc_iframe_liga_form_estado.scInlineFormReceive)
  {
    parent.nmsc_iframe_liga_form_estado.scInlineFormReceive(oResp, <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_estado_inline']['inline_form_seq'] ?>);
    return true;
  }
<?php
  }
...
?>  
  ...
  {
    parent.scInlineFormReceive(oResp, <?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_estado_inline']['inline_form_seq'] ?>);
    return true;
  }
<?php
  }
