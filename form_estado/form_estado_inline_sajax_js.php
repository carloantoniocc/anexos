  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_estado_inline" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_est_
  function do_ajax_form_estado_inline_validate_id_est_()
  {
    var nomeCampo_id_est_ = "id_est_";
    var var_id_est_ = scAjaxGetFieldText(nomeCampo_id_est_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estado_inline_validate_id_est_(var_id_est_, var_script_case_init, do_ajax_form_estado_inline_validate_id_est__cb);
  } // do_ajax_form_estado_inline_validate_id_est_

  function do_ajax_form_estado_inline_validate_id_est__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estado_inline_validate_id_est__cb

  // ---------- Validate desc_est_
  function do_ajax_form_estado_inline_validate_desc_est_()
  {
    var nomeCampo_desc_est_ = "desc_est_";
    var var_desc_est_ = scAjaxGetFieldText(nomeCampo_desc_est_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estado_inline_validate_desc_est_(var_desc_est_, var_script_case_init, do_ajax_form_estado_inline_validate_desc_est__cb);
  } // do_ajax_form_estado_inline_validate_desc_est_

  function do_ajax_form_estado_inline_validate_desc_est__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estado_inline_validate_desc_est__cb
  // ---------- Form
  function do_ajax_form_estado_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_estado_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_est_ = scAjaxGetFieldText("id_est_");
    var var_desc_est_ = scAjaxGetFieldText("desc_est_");
    ...
    scAjaxProcOn();
    x_ajax_form_estado_inline_submit_form(var_id_est_, var_desc_est_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_estado_inline_submit_form_cb);
  } // do_ajax_form_estado_inline_submit_form

  function do_ajax_form_estado_inline_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_est_");
      scAjaxHideErrorDisplay("desc_est_");
      scLigEditLookupCall();
    }
  ...
  } // do_ajax_form_estado_inline_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_estado_inline_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_estado_inline_navigate_form(var_id_est_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_estado_inline_navigate_form_cb);
  } // do_ajax_form_estado_inline_navigate_form

  function do_ajax_form_estado_inline_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_estado_inline_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
...
{
?>
    do_ajax_form_estado_inline_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_estado_inline_navigate_form_cb
  function sc_hide_form_estado_inline_form()
  {
  ...
  ajax_field_list[0] = "id_est_";
  ajax_field_list[1] = "desc_est_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_est_": {"label": "Código", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "desc_est_": {"label": "Descripción", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["id_est_"][1] = "id_est_";
  ajax_field_mult["desc_est_"][1] = "desc_est_";

  var ajax_field_id = {
    "id_est_": new Array("hidden_field_label_id_est_", "hidden_field_data_id_est_"),
    "desc_est_": new Array("hidden_field_label_desc_est_", "hidden_field_data_desc_est_")
  };
