...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_est_
  function do_ajax_form_estado_validate_id_est_(iNumLinha)
  {
    var nomeCampo_id_est_ = "id_est_" + iNumLinha;
    var var_id_est_ = scAjaxGetFieldText(nomeCampo_id_est_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estado_validate_id_est_(var_id_est_, iNumLinha, var_script_case_init, do_ajax_form_estado_validate_id_est__cb);
  } // do_ajax_form_estado_validate_id_est_

  function do_ajax_form_estado_validate_id_est__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_est_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_est_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_est_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_est_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estado_validate_id_est__cb

  // ---------- Validate desc_est_
  function do_ajax_form_estado_validate_desc_est_(iNumLinha)
  {
    var nomeCampo_desc_est_ = "desc_est_" + iNumLinha;
    var var_desc_est_ = scAjaxGetFieldText(nomeCampo_desc_est_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estado_validate_desc_est_(var_desc_est_, iNumLinha, var_script_case_init, do_ajax_form_estado_validate_desc_est__cb);
  } // do_ajax_form_estado_validate_desc_est_

  function do_ajax_form_estado_validate_desc_est__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "desc_est_" + iLineNumber;
    }
    else
    {
      sFieldValid = "desc_est_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "desc_est_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "desc_est_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_estado_validate_desc_est__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_estado_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_estado_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_estado_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_estado_add_new_line_cb);
  } // do_ajax_form_estado_add_new_line

  function do_ajax_form_estado_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_estado_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_estado_backup_line(iNumLinha)
  {
    var var_id_est_ = scAjaxGetFieldText("id_est_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_estado_backup_line(var_id_est_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_estado_backup_line_cb);
  } // do_ajax_form_estado_backup_line

  function do_ajax_form_estado_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_estado_backup_line_cb

  function do_ajax_form_estado_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_estado_cancel_insert

  function do_ajax_form_estado_cancel_update(iSeqVert)
  {
    do_ajax_form_estado_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_estado_cancel_update

  function do_ajax_form_estado_restore_buttons()
  {
<?php
...
?>
  ...
  // ---------- table_refresh
  function do_ajax_form_estado_table_refresh()
  {
    var var_id_est_ = document.F2.id_est_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_estado_table_refresh(var_id_est_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_estado_table_refresh_cb);
  } //  do_ajax_form_estado_table_refresh

  function do_ajax_form_estado_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.id_est_.value = scAjaxGetKeyValue("id_est_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_estado_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_estado_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_estado_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_est_ = scAjaxGetFieldText("id_est_" + iNumLinha);
    var var_desc_est_ = scAjaxGetFieldText("desc_est_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_estado_submit_form(var_id_est_, var_desc_est_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_estado_submit_form_cb);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_est_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("desc_est_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  function do_ajax_form_estado_navigate_form()
  {
    ...
    if (sc_insert_open)
    {
        do_ajax_form_estado_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("id_est_" + iNavForm);
      scAjaxHideErrorDisplay("desc_est_" + iNavForm);
    }
    var var_id_est_ = document.F2.id_est_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_estado_navigate_form(var_id_est_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_estado_navigate_form_cb);
  ...
  function do_ajax_form_estado_navigate_form_cb(sResp)
  {
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_est_.value = scAjaxGetKeyValue("id_est_" + var_last_index);
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_est_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "desc_est_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_est_" + iNumLinha] = {"label": "Código<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["desc_est_" + iNumLinha] = {"label": "Descripción<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_est_"][iNumLinha] = "id_est_" + iNumLinha;
    ajax_field_mult["desc_est_"][iNumLinha] = "desc_est_" + iNumLinha;
    ajax_field_id["id_est_" + iNumLinha] = new Array("hidden_field_label_id_est_", "hidden_field_data_id_est_" + iNumLinha);
    ajax_field_id["desc_est_" + iNumLinha] = new Array("hidden_field_label_desc_est_", "hidden_field_data_desc_est_" + iNumLinha);
    ajax_error_count["id_est_" + iNumLinha] = "off";
    ajax_error_count["desc_est_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_est_" + iNumLinha] = "on";
    ajax_read_only["desc_est_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_est_" + iNumLinha] = "on";
    ajax_read_only["desc_est_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["id_est_" + iNumLinha] = null;
    ajax_error_list["desc_est_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_est_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_est_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_est_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_est_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_est_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["desc_est_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["desc_est_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["desc_est_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["desc_est_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["desc_est_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_est_'])) ? $this->nmgp_cmp_readonly['id_est_'] : 'on';
?>
    scAjaxFieldRead("id_est_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['desc_est_'])) ? $this->nmgp_cmp_readonly['desc_est_'] : 'off';
?>
    scAjaxFieldRead("desc_est_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_est_" + iSeq, "on");
    scAjaxFieldRead("desc_est_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_est_" + iRow] || "on" == ajax_error_count["desc_est_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_id_est_" + iRow))
        document.getElementById("hidden_field_data_id_est_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_desc_est_" + iRow))
        document.getElementById("hidden_field_data_desc_est_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_est_" + iRow] && "off" == ajax_error_count["desc_est_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_est_" + iRow] = "off";
        ajax_error_count["desc_est_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_id_est_" + iRow))
        document.getElementById("hidden_field_data_id_est_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_desc_est_" + iRow))
        document.getElementById("hidden_field_data_desc_est_" + iRow).className = sCssLine;
    }
  }
