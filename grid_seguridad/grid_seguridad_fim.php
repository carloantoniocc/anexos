...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["Anexos_____grid_seguridad"]))
   {
      unset($_SESSION['session_sec_aplicacao']["Anexos_____grid_seguridad"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_seguridad']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_seguridad']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_seguridad']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_seguridad']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_seguridad']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_seguridad']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_seguridad']['embutida_filho'] as $ind => $sc_init)
          {
