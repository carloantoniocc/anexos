...
?>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['patente1'])) ? $this->New_label['patente1'] : "Patente 1"; ?></TD>
      
      <INPUT type="hidden" id="SC_patente1_cond" name="patente1_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_patente1" <?php echo $str_hide_patente1?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_patente1" name="patente1_autocomp" size="6" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 6, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: true}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['patente2'])) ? $this->New_label['patente2'] : "Patente 2"; ?></TD>
      
      <INPUT type="hidden" id="SC_patente2_cond" name="patente2_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_patente2" <?php echo $str_hide_patente2?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
