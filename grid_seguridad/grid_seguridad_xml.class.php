...
class grid_seguridad_xml
{
   ...
   function inicializa_vars()
   {
      ...
      $this->Arquivo     .= ".xml";
      $this->Tit_doc      = "grid_seguridad.xml";
   ...
   function grava_arquivo()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad']['xml_name']))
      {
          $this->Arquivo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad']['xml_name'];
          $this->Tit_doc = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad']['xml_name'];
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad']['xml_name']);
      }
      if (!$this->Grava_view)
      {
      ...
      while (!$rs->EOF)
      {
         $this->xml_registro = "<grid_seguridad";
   ...
   function NM_export_patente1()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->patente1))
         {
             $this->patente1 = sc_convert_encoding($this->patente1, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " patente1 =\"" . $this->trata_dados($this->patente1) . "\"";
   }
   //----- patente2
   function NM_export_patente2()
   {
         ...
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->patente2))
         {
             $this->patente2 = sc_convert_encoding($this->patente2, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " patente2 =\"" . $this->trata_dados($this->patente2) . "\"";
   }
   //----- actualiza
   function NM_export_actualiza()
   {
         if ($_SESSION['scriptcase']['charset'] == "UTF-8" && !NM_is_utf8($this->actualiza))
         {
             $this->actualiza = sc_convert_encoding($this->actualiza, "UTF-8", $_SESSION['scriptcase']['charset']);
         }
         $this->xml_registro .= " actualiza =\"" . $this->trata_dados($this->actualiza) . "\"";
   }
   ...
   function monta_html()
   {
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad']['xml_file']);
      if (is_file($this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_seguridad']['xml_file'] = $this->Ini->root . $this->Ini->path_imag_temp . "/" . $this->Arquivo;
      }
...
<FORM name="F0" method=post action="grid_seguridad.php" style="display: none"> 
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
