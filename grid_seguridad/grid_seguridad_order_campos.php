<?php
   ...
   if (!function_exists("NM_is_utf8"))
   {
    ...
    $Ord_Cmp = new grid_seguridad_Ord_cmp(); 
    $Ord_Cmp->Ord_cmp_init();
   
class grid_seguridad_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels     = array();
   $tab_ger_campos['fotos'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['fotos'] = "fotos";
       $tab_converte["fotos"]   = "fotos";
   }
   else
   {
       $tab_def_campos['fotos'] = "";
       $tab_converte[""]   = "fotos";
   }
   $tab_labels["fotos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["fotos"])) ? $_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["fotos"] : "";
   $tab_ger_campos['anexo'] = "on";
   $tab_def_campos['anexo'] = "Anexo";
   $tab_converte["Anexo"]   = "anexo";
   $tab_labels["anexo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["anexo"])) ? $_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["anexo"] : "Anexo";
   $tab_ger_campos['ap_pat'] = "on";
   $tab_def_campos['ap_pat'] = "Ap_Pat";
   $tab_converte["Ap_Pat"]   = "ap_pat";
   $tab_labels["ap_pat"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["ap_pat"])) ? $_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["ap_pat"] : "Apellido Paterno";
   $tab_ger_campos['ap_mat'] = "on";
   $tab_def_campos['ap_mat'] = "Ap_Mat";
   $tab_converte["Ap_Mat"]   = "ap_mat";
   $tab_labels["ap_mat"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["ap_mat"])) ? $_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["ap_mat"] : "Apellido Materno";
   $tab_ger_campos['nombres'] = "on";
   $tab_def_campos['nombres'] = "Nombres";
   $tab_converte["Nombres"]   = "nombres";
   $tab_labels["nombres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["nombres"])) ? $_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["nombres"] : "Nombres";
   $tab_ger_campos['correo'] = "on";
   $tab_def_campos['correo'] = "Correo";
   $tab_converte["Correo"]   = "correo";
   $tab_labels["correo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["correo"])) ? $_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["correo"] : "Correo";
   $tab_ger_campos['depto'] = "on";
   $tab_def_campos['depto'] = "Depto";
   $tab_converte["Depto"]   = "depto";
   $tab_labels["depto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["depto"])) ? $_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["depto"] : "Departamentoto";
   $tab_ger_campos['piso'] = "on";
   $tab_def_campos['piso'] = "Piso";
   $tab_converte["Piso"]   = "piso";
   $tab_labels["piso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["piso"])) ? $_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["piso"] : "Piso";
   $tab_ger_campos['nodo'] = "on";
   $tab_def_campos['nodo'] = "nodo";
   $tab_converte["nodo"]   = "nodo";
   $tab_labels["nodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["nodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["nodo"] : "Establecimiento";
   $tab_ger_campos['patente1'] = "on";
   $tab_def_campos['patente1'] = "patente1";
   $tab_converte["patente1"]   = "patente1";
   $tab_labels["patente1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["patente1"])) ? $_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["patente1"] : "Patente 1";
   $tab_ger_campos['patente2'] = "on";
   $tab_def_campos['patente2'] = "patente2";
   $tab_converte["patente2"]   = "patente2";
   $tab_labels["patente2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["patente2"])) ? $_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["patente2"] : "Patente 2";
   $tab_ger_campos['actualiza'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['actualiza'] = "actualiza";
       $tab_converte["actualiza"]   = "actualiza";
   }
   else
   {
       $tab_def_campos['actualiza'] = "";
       $tab_converte[""]   = "actualiza";
   }
   $tab_labels["actualiza"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["actualiza"])) ? $_SESSION['sc_session'][$sc_init]['grid_seguridad']['labels']["actualiza"] : "";
   $tab_ger_campos['fotos'] = "none";
   $tab_ger_campos['actualiza'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_seguridad']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_seguridad']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_seguridad']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_seguridad']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_seguridad']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_seguridad']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_seguridad']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_seguridad']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       {
           $_SESSION['sc_session'][$sc_init]['grid_seguridad']['ordem_select'][$campo] = $ordem;
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   $.ajax({
    type: "POST",
    url: "grid_seguridad_order_campos.php",
    data: {
...
<?php
   foreach ($tab_ger_campos as $NM_cada_field => $NM_cada_opc)
   {
       if ($NM_cada_opc != "none")
       {
           if (!isset($_SESSION['sc_session'][$sc_init]['grid_seguridad']['ordem_select'][$tab_def_campos[$NM_cada_field]]))
           {
?>
...
<?php
   foreach ($_SESSION['sc_session'][$sc_init]['grid_seguridad']['ordem_select'] as $NM_cada_field => $NM_cada_opc)
   {
