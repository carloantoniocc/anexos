...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_foto' + iSeqRow).bind('blur', function() { sc_form_foto_foto_onblur(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_foto_foto_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_foto_foto_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_form_foto_foto_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}
