...
<?php
include_once("form_foto_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_foto_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_foto']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto']['recarga'];
}
?>
...
<?php
 include_once("form_foto_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_foto'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_foto'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_foto']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto']['run_iframe'] != "R")
{
?>
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_foto']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_foto");
 parent.scAjaxDetailHeight("form_foto", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
