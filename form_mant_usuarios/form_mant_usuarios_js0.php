...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_mant_usuarios"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_mant_usuarios']['where_detal']))
  {
?>  
...
{ 
    ...
    Nm_Proc_Atualiz = true;
    do_ajax_form_mant_usuarios_submit_form(y, z); 
} 
<?php
}
?>
