...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_cat_
  function do_ajax_form_categorias_inline_validate_id_cat_()
  {
    var nomeCampo_id_cat_ = "id_cat_";
    var var_id_cat_ = scAjaxGetFieldText(nomeCampo_id_cat_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_inline_validate_id_cat_(var_id_cat_, var_script_case_init, do_ajax_form_categorias_inline_validate_id_cat__cb);
  } // do_ajax_form_categorias_inline_validate_id_cat_

  function do_ajax_form_categorias_inline_validate_id_cat__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_inline_validate_id_cat__cb

  // ---------- Validate desc_cat_
  function do_ajax_form_categorias_inline_validate_desc_cat_()
  {
    var nomeCampo_desc_cat_ = "desc_cat_";
    var var_desc_cat_ = scAjaxGetFieldText(nomeCampo_desc_cat_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_inline_validate_desc_cat_(var_desc_cat_, var_script_case_init, do_ajax_form_categorias_inline_validate_desc_cat__cb);
  } // do_ajax_form_categorias_inline_validate_desc_cat_

  function do_ajax_form_categorias_inline_validate_desc_cat__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_inline_validate_desc_cat__cb
  // ---------- Form
  function do_ajax_form_categorias_inline_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_categorias_inline_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id_cat_ = scAjaxGetFieldText("id_cat_");
    var var_desc_cat_ = scAjaxGetFieldText("desc_cat_");
    ...
    scAjaxProcOn();
    x_ajax_form_categorias_inline_submit_form(var_id_cat_, var_desc_cat_, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_categorias_inline_submit_form_cb);
  ...
  function do_ajax_form_categorias_inline_submit_form_cb(sResp)
  {
    ...
    if (scAjaxIsOk())
    {
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_cat_");
      scAjaxHideErrorDisplay("desc_cat_");
      scLigEditLookupCall();
    }
  ...
  function do_ajax_form_categorias_inline_navigate_form()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_categorias_inline_navigate_form(var_id_cat_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_categorias_inline_navigate_form_cb);
  ...
  function do_ajax_form_categorias_inline_navigate_form_cb(sResp)
  {
    ...
    else if (oResp["navSummary"].reg_tot == 0)
    {
       ...
       sc_hide_form_categorias_inline_form();
    }
    sc_mupload_ok = true;
    scAjaxSetFields();
...
?>
  ...
  function sc_hide_form_categorias_inline_form()
  {
  ...
  ajax_field_list[0] = "id_cat_";
  ajax_field_list[1] = "desc_cat_";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "id_cat_": {"label": "Id Cat", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "desc_cat_": {"label": "Desc Cat", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["id_cat_"][1] = "id_cat_";
  ajax_field_mult["desc_cat_"][1] = "desc_cat_";

  var ajax_field_id = {
    "id_cat_": new Array("hidden_field_label_id_cat_", "hidden_field_data_id_cat_"),
    "desc_cat_": new Array("hidden_field_label_desc_cat_", "hidden_field_data_desc_cat_")
  };
