...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_cat_
  function do_ajax_form_categorias_validate_id_cat_(iNumLinha)
  {
    var nomeCampo_id_cat_ = "id_cat_" + iNumLinha;
    var var_id_cat_ = scAjaxGetFieldText(nomeCampo_id_cat_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_validate_id_cat_(var_id_cat_, iNumLinha, var_script_case_init, do_ajax_form_categorias_validate_id_cat__cb);
  } // do_ajax_form_categorias_validate_id_cat_

  function do_ajax_form_categorias_validate_id_cat__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_cat_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_cat_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_cat_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_cat_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_validate_id_cat__cb

  // ---------- Validate desc_cat_
  function do_ajax_form_categorias_validate_desc_cat_(iNumLinha)
  {
    var nomeCampo_desc_cat_ = "desc_cat_" + iNumLinha;
    var var_desc_cat_ = scAjaxGetFieldText(nomeCampo_desc_cat_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_validate_desc_cat_(var_desc_cat_, iNumLinha, var_script_case_init, do_ajax_form_categorias_validate_desc_cat__cb);
  } // do_ajax_form_categorias_validate_desc_cat_

  function do_ajax_form_categorias_validate_desc_cat__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "desc_cat_" + iLineNumber;
    }
    else
    {
      sFieldValid = "desc_cat_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "desc_cat_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "desc_cat_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_categorias_validate_desc_cat__cb
  ...
  {
    var var_id_cat_ = scAjaxGetFieldText("id_cat_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_categorias_backup_line(var_id_cat_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_categorias_backup_line_cb);
...
?>
  ...
  {
    var var_id_cat_ = document.F2.id_cat_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_categorias_table_refresh(var_id_cat_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_categorias_table_refresh_cb);
  ...
  function do_ajax_form_categorias_table_refresh_cb(sResp)
  {
    ...
    document.F2.id_cat_.value = scAjaxGetKeyValue("id_cat_");
  ...
  function do_ajax_form_categorias_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_categorias_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_cat_ = scAjaxGetFieldText("id_cat_" + iNumLinha);
    var var_desc_cat_ = scAjaxGetFieldText("desc_cat_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_categorias_submit_form(var_id_cat_, var_desc_cat_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_categorias_submit_form_cb);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_cat_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("desc_cat_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  function do_ajax_form_categorias_navigate_form()
  {
    ...
    {
      scAjaxHideErrorDisplay("id_cat_" + iNavForm);
      scAjaxHideErrorDisplay("desc_cat_" + iNavForm);
    }
    var var_id_cat_ = document.F2.id_cat_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_categorias_navigate_form(var_id_cat_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_categorias_navigate_form_cb);
  ...
  function do_ajax_form_categorias_navigate_form_cb(sResp)
  {
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_cat_.value = scAjaxGetKeyValue("id_cat_" + var_last_index);
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_cat_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "desc_cat_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_cat_" + iNumLinha] = {"label": "Id Cat<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["desc_cat_" + iNumLinha] = {"label": "Desc Cat<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_cat_"][iNumLinha] = "id_cat_" + iNumLinha;
    ajax_field_mult["desc_cat_"][iNumLinha] = "desc_cat_" + iNumLinha;
    ajax_field_id["id_cat_" + iNumLinha] = new Array("hidden_field_label_id_cat_", "hidden_field_data_id_cat_" + iNumLinha);
    ajax_field_id["desc_cat_" + iNumLinha] = new Array("hidden_field_label_desc_cat_", "hidden_field_data_desc_cat_" + iNumLinha);
    ajax_error_count["id_cat_" + iNumLinha] = "off";
    ajax_error_count["desc_cat_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_cat_" + iNumLinha] = "on";
    ajax_read_only["desc_cat_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_cat_" + iNumLinha] = "on";
    ajax_read_only["desc_cat_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["id_cat_" + iNumLinha] = null;
    ajax_error_list["desc_cat_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_cat_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_cat_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_cat_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_cat_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_cat_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["desc_cat_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["desc_cat_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["desc_cat_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["desc_cat_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["desc_cat_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_cat_'])) ? $this->nmgp_cmp_readonly['id_cat_'] : 'on';
?>
    scAjaxFieldRead("id_cat_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['desc_cat_'])) ? $this->nmgp_cmp_readonly['desc_cat_'] : 'off';
?>
    scAjaxFieldRead("desc_cat_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_cat_" + iSeq, "on");
    scAjaxFieldRead("desc_cat_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_cat_" + iRow] || "on" == ajax_error_count["desc_cat_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_id_cat_" + iRow))
        document.getElementById("hidden_field_data_id_cat_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_desc_cat_" + iRow))
        document.getElementById("hidden_field_data_desc_cat_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_cat_" + iRow] && "off" == ajax_error_count["desc_cat_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_cat_" + iRow] = "off";
        ajax_error_count["desc_cat_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_id_cat_" + iRow))
        document.getElementById("hidden_field_data_id_cat_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_desc_cat_" + iRow))
        document.getElementById("hidden_field_data_desc_cat_" + iRow).className = sCssLine;
    }
  }
