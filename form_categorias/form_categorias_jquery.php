...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id_cat_' + iSeqRow).bind('blur', function() { sc_form_categorias_id_cat__onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_categorias_id_cat__onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_desc_cat_' + iSeqRow).bind('blur', function() { sc_form_categorias_desc_cat__onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_categorias_desc_cat__onchange(this, iSeqRow) })
...
function sc_form_categorias_id_cat__onblur(oThis, iSeqRow) {
  do_ajax_form_categorias_validate_id_cat_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_categorias_id_cat__onchange(oThis, iSeqRow) {
...
function sc_form_categorias_desc_cat__onblur(oThis, iSeqRow) {
  do_ajax_form_categorias_validate_desc_cat_(iSeqRow);
  scCssBlur(oThis, iSeqRow);
}

function sc_form_categorias_desc_cat__onchange(oThis, iSeqRow) {
  nm_check_insert(iSeqRow);
}
