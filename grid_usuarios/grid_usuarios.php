<?php
   ...
   @session_start() ;
   $_SESSION['scriptcase']['grid_usuarios']['glo_nm_perfil']          = "anexos_prod";
...
// 
      ...
      $this->arr_buttons_usr['Admin']['hint']             = "";
      $this->arr_buttons_usr['Admin']['type']             = "button";
      $this->arr_buttons_usr['Admin']['value']            = "Administración";
      $this->arr_buttons_usr['Admin']['display']          = "only_text";
      $this->arr_buttons_usr['Admin']['display_position'] = "text_right";
      $this->arr_buttons_usr['Admin']['style']            = "default";
      $this->arr_buttons_usr['Admin']['image']            = "";

      $this->arr_buttons_usr['Seguridad']['hint']             = "";
      $this->arr_buttons_usr['Seguridad']['type']             = "button";
      $this->arr_buttons_usr['Seguridad']['value']            = "Seguridad";
      $this->arr_buttons_usr['Seguridad']['display']          = "only_text";
      $this->arr_buttons_usr['Seguridad']['display_position'] = "text_right";
      $this->arr_buttons_usr['Seguridad']['style']            = "default";
      $this->arr_buttons_usr['Seguridad']['image']            = "";
      ...
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      ob_start();
      $this->prep_conect();
      $this->conectDB();
...
<?php
   ...
   function conectDB()
   {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['grid_usuarios']['glo_nm_conexao'], $this->root . $this->path_prod, 'Anexos'); 
      } 
      else 
      { 
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if ($nmgp_opcao != "ajax_navigate" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['sc_modal']))
      {
          ...
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_usuarios']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('grid_usuarios') . "/grid_usuarios.php";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['grid_usuarios']['label'] = "grid_usuarios";
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "fotos";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "anexo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "ap_pat";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "ap_mat";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "nombres";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "correo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "depto";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "piso";
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['field_order'][] = "nodo";
...
?>
<FORM name="F0" method=post action="grid_usuarios.php" target="<?php echo $NM_target; ?>"> 
...
<?php
  ...
  if (!isset($this->Campos_Mens_erro) || empty($this->Campos_Mens_erro))
 {
$this->nmgp_redireciona_form($this->Ini->path_link . "" . SC_dir_app_name('grid_seguridad') . "/grid_seguridad.php", $this->nm_location, "","_self", 440, 630);
 };
$_SESSION['scriptcase']['grid_usuarios']['contr_erro'] = 'off'; 
?>
      </td></tr><tr><td align="center">
...
?>
  ...
  function close_emb()
  {
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      if (isset($Nm_datas[$campo_join]) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['SC_sep_date']))
      {
...
<FORM name="F0" method=post action="grid_usuarios.php"> 
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
...
//======= =========================
   ...
   else
   {
       ...
       if ('grid_usuarios' == $sReferer || 'grid_usuarios_' == substr($sReferer, 0, 14))
       {
           $_SESSION['sc_session'][$script_case_init]['grid_usuarios']['initialize'] = false;
       }
       else
