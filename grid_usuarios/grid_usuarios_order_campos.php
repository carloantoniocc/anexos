...
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $tab_ger_campos, $tab_def_campos, $tab_converte, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   $tab_labels["fotos"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["fotos"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["fotos"] : "";
   $tab_ger_campos['anexo'] = "on";
   $tab_def_campos['anexo'] = "Anexo";
   $tab_converte["Anexo"]   = "anexo";
   $tab_labels["anexo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["anexo"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["anexo"] : "Anexo";
   $tab_ger_campos['ap_pat'] = "on";
   $tab_def_campos['ap_pat'] = "Ap_Pat";
   $tab_converte["Ap_Pat"]   = "ap_pat";
   $tab_labels["ap_pat"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["ap_pat"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["ap_pat"] : "Apellido Paterno";
   $tab_ger_campos['ap_mat'] = "on";
   $tab_def_campos['ap_mat'] = "Ap_Mat";
   $tab_converte["Ap_Mat"]   = "ap_mat";
   $tab_labels["ap_mat"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["ap_mat"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["ap_mat"] : "Apellido Materno";
   $tab_ger_campos['nombres'] = "on";
   $tab_def_campos['nombres'] = "Nombres";
   $tab_converte["Nombres"]   = "nombres";
   $tab_labels["nombres"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["nombres"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["nombres"] : "Nombres";
   ...
   $tab_labels["depto"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["depto"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["depto"] : "Departamentoto";
   $tab_ger_campos['piso'] = "on";
   $tab_def_campos['piso'] = "Piso";
   $tab_converte["Piso"]   = "piso";
   $tab_labels["piso"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["piso"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["piso"] : "Piso";
   $tab_ger_campos['nodo'] = "on";
   $tab_def_campos['nodo'] = "nodo";
   $tab_converte["nodo"]   = "nodo";
   $tab_labels["nodo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["nodo"])) ? $_SESSION['sc_session'][$sc_init]['grid_usuarios']['labels']["nodo"] : "Establecimiento";
