...
//-- ajax metodos ---
   ...
   function lookup_ajax_anexo($anexo)
   {
      ...
      {
          $nm_comando = "select distinct Anexo from " . $this->Ini->nm_tabela . " where anexo <> 1 and  Anexo like '%" . $anexo . "%'"; 
      }
      else
      {
          $nm_comando = "select distinct Anexo from " . $this->Ini->nm_tabela . " where anexo <> 1 and  Anexo like '%" . $anexo . "%'"; 
   ...
   function lookup_ajax_nombres($nombres)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Nombres from " . $this->Ini->nm_tabela . " where anexo <> 1 and  Nombres like '%" . $nombres . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_ap_pat($ap_pat)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Ap_Pat from " . $this->Ini->nm_tabela . " where anexo <> 1 and  Ap_Pat like '%" . $ap_pat . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function lookup_ajax_ap_mat($ap_mat)
   {
      ...
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Ap_Mat from " . $this->Ini->nm_tabela . " where anexo <> 1 and  Ap_Mat like '%" . $ap_mat . "%'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['SC_sep_date1'];
          }
      }
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="grid_usuarios.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
 <INPUT type="hidden" name="script_case_session" value="<?php echo NM_encode_input(session_id()); ?>"> 
...
<?php
   ...
   function monta_form()
   {
      ...
      { 
          ...
          $anexo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['anexo']; 
          $anexo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['anexo_cond']; 
          $nombres = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['nombres']; 
          $nombres_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['nombres_cond']; 
          $ap_pat = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['ap_pat']; 
          $ap_pat_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['ap_pat_cond']; 
          $ap_mat = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['ap_mat']; 
          $ap_mat_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['ap_mat_cond']; 
          $depto = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['depto']; 
          $depto_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['depto_cond']; 
          $nodo = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['nodo']; 
          $nodo_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['nodo_cond']; 
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['anexo'])) ? $this->New_label['anexo'] : "Anexo"; ?></TD>
      
      <INPUT type="hidden" id="SC_anexo_cond" name="anexo_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_anexo" <?php echo $str_hide_anexo?> valign="top">
...
<?php
   ...
   { 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
      {
          $nm_comando = "select distinct Anexo from " . $this->Ini->nm_tabela . " where anexo <> 1 and Anexo = $anexo_look"; 
      }
      else
      {
          $nm_comando = "select distinct Anexo from " . $this->Ini->nm_tabela . " where anexo <> 1 and Anexo = $anexo_look"; 
...
?>
<INPUT  type="text" id="SC_anexo" name="anexo" value="<?php echo NM_encode_input($anexo) ?>" size=6 alt="{datatype: 'integer', maxLength: 6, thousandsSep: '', allowNegative: false, onlyNegative: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_anexo" name="anexo_autocomp" size="6" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'integer', maxLength: 6, thousandsSep: '', allowNegative: false, onlyNegative: false, enterTab: false}">
...
<?php
      $nombres_look = substr($this->Db->qstr($nombres), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Nombres from " . $this->Ini->nm_tabela . " where anexo <> 1 and Nombres = '$nombres_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_nombres" name="nombres" value="<?php echo NM_encode_input($nombres) ?>" size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_nombres" name="nombres_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['ap_pat'])) ? $this->New_label['ap_pat'] : "Apellido Paterno"; ?></TD>
      
      <INPUT type="hidden" id="SC_ap_pat_cond" name="ap_pat_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ap_pat" <?php echo $str_hide_ap_pat?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<?php
      $ap_pat_look = substr($this->Db->qstr($ap_pat), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Ap_Pat from " . $this->Ini->nm_tabela . " where anexo <> 1 and Ap_Pat = '$ap_pat_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_ap_pat" name="ap_pat" value="<?php echo NM_encode_input($ap_pat) ?>" size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_ap_pat" name="ap_pat_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['ap_mat'])) ? $this->New_label['ap_mat'] : "Apellido Materno"; ?></TD>
      
      <INPUT type="hidden" id="SC_ap_mat_cond" name="ap_mat_cond" value="qp">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_ap_mat" <?php echo $str_hide_ap_mat?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<?php
      $ap_mat_look = substr($this->Db->qstr($ap_mat), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct Ap_Mat from " . $this->Ini->nm_tabela . " where anexo <> 1 and Ap_Mat = '$ap_mat_look'"; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
...
?>
<INPUT  type="text" id="SC_ap_mat" name="ap_mat" value="<?php echo NM_encode_input($ap_mat) ?>" size=20 alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectEven" type="text" id="id_ac_ap_mat" name="ap_mat_autocomp" size="20" value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 20, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD class="scFilterLabelOdd"><?php echo (isset($this->New_label['depto'])) ? $this->New_label['depto'] : "Departamento"; ?></TD>
      
      <INPUT type="hidden" id="SC_depto_cond" name="depto_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_depto" <?php echo $str_hide_depto?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['psq_check_ret']['depto'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['psq_check_ret']['depto'][] = trim($rs->fields[0]);
...
?>
      ...
      <TD class="scFilterLabelEven"><?php echo (isset($this->New_label['nodo'])) ? $this->New_label['nodo'] : "Establecimiento"; ?></TD>
      
      <INPUT type="hidden" id="SC_nodo_cond" name="nodo_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_nodo" <?php echo $str_hide_nodo?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['psq_check_ret']['nodo'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['psq_check_ret']['nodo'][] = trim($rs->fields[0]);
            $nmgp_def_dados .= trim($rs->fields[1]) . "?#?" ; 
            $nmgp_def_dados .= trim($rs->fields[0]) . "?#?N?@?" ; 
            $rs->MoveNext() ; 
         } 
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="grid_usuarios.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
   ...
   function trata_campos()
   {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['psq_check_ret']['depto'])) {
      ...
      if (!empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['psq_check_ret']['nodo'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['anexo'] = $anexo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['anexo_cond'] = $anexo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['nombres'] = $nombres; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['nombres_cond'] = $nombres_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['ap_pat'] = $ap_pat; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['ap_pat_cond'] = $ap_pat_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['ap_mat'] = $ap_mat; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['ap_mat_cond'] = $ap_mat_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['depto'] = $depto; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['depto_cond'] = $depto_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['nodo'] = $nodo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_usuarios']['campos_busca']['nodo_cond'] = $nodo_cond_salva; 
