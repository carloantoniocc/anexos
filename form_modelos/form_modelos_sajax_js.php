  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_modelos" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_mod_
  function do_ajax_form_modelos_validate_id_mod_(iNumLinha)
  {
    var nomeCampo_id_mod_ = "id_mod_" + iNumLinha;
    var var_id_mod_ = scAjaxGetFieldText(nomeCampo_id_mod_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_modelos_validate_id_mod_(var_id_mod_, iNumLinha, var_script_case_init, do_ajax_form_modelos_validate_id_mod__cb);
  } // do_ajax_form_modelos_validate_id_mod_

  function do_ajax_form_modelos_validate_id_mod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "id_mod_" + iLineNumber;
    }
    else
    {
      sFieldValid = "id_mod_";
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "id_mod_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "id_mod_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_modelos_validate_id_mod__cb

  // ---------- Validate desc_mod_
  function do_ajax_form_modelos_validate_desc_mod_(iNumLinha)
  {
    var nomeCampo_desc_mod_ = "desc_mod_" + iNumLinha;
    var var_desc_mod_ = scAjaxGetFieldText(nomeCampo_desc_mod_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_modelos_validate_desc_mod_(var_desc_mod_, iNumLinha, var_script_case_init, do_ajax_form_modelos_validate_desc_mod__cb);
  } // do_ajax_form_modelos_validate_desc_mod_

  function do_ajax_form_modelos_validate_desc_mod__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "desc_mod_" + iLineNumber;
    }
    else
    {
      sFieldValid = "desc_mod_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "desc_mod_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "desc_mod_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_modelos_validate_desc_mod__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_modelos_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_modelos_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_modelos_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_modelos_add_new_line_cb);
  } // do_ajax_form_modelos_add_new_line

  function do_ajax_form_modelos_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
  ...
  } // do_ajax_form_modelos_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_modelos_backup_line(iNumLinha)
  {
    var var_id_mod_ = scAjaxGetFieldText("id_mod_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_modelos_backup_line(var_id_mod_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_modelos_backup_line_cb);
  } // do_ajax_form_modelos_backup_line

  function do_ajax_form_modelos_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    if (!scAjaxHasError())
    {
  ...
  } // do_ajax_form_modelos_backup_line_cb

  function do_ajax_form_modelos_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_modelos_cancel_insert

  function do_ajax_form_modelos_cancel_update(iSeqVert)
  {
    do_ajax_form_modelos_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_modelos_cancel_update

  function do_ajax_form_modelos_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_modelos_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_modelos_table_refresh()
  {
    var var_id_mod_ = document.F2.id_mod_.value;
    ...
    scAjaxProcOn();
    x_ajax_form_modelos_table_refresh(var_id_mod_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_modelos_table_refresh_cb);
  } //  do_ajax_form_modelos_table_refresh

  function do_ajax_form_modelos_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    document.F2.id_mod_.value = scAjaxGetKeyValue("id_mod_");
    ...
    sc_insert_open = false;
  } // do_ajax_form_modelos_table_refresh_cb

  // ---------- Form
  var sc_num_ult_line = "";
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_modelos_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_modelos_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_mod_ = scAjaxGetFieldText("id_mod_" + iNumLinha);
    var var_desc_mod_ = scAjaxGetFieldText("desc_mod_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_modelos_submit_form(var_id_mod_, var_desc_mod_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_modelos_submit_form_cb);
  } // do_ajax_form_modelos_submit_form

  function do_ajax_form_modelos_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxShowMessage();
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("id_mod_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("desc_mod_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetFields();
...
?>
  ...
  } // do_ajax_form_modelos_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_modelos_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_modelos_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("id_mod_" + iNavForm);
      scAjaxHideErrorDisplay("desc_mod_" + iNavForm);
    }
    var var_id_mod_ = document.F2.id_mod_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_modelos_navigate_form(var_id_mod_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_modelos_navigate_form_cb);
  } // do_ajax_form_modelos_navigate_form

  function do_ajax_form_modelos_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    if (oResp['empty_filter'] && oResp['empty_filter'] == "ok")
    ...
    sc_mupload_ok = true;
    scAjaxSetFields();
    document.F2.id_mod_.value = scAjaxGetKeyValue("id_mod_" + var_last_index);
...
?>
  ...
  } // do_ajax_form_modelos_navigate_form_cb
  function sc_hide_form_modelos_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_modelos_form
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "id_mod_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "desc_mod_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["id_mod_" + iNumLinha] = {"label": "Código<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["desc_mod_" + iNumLinha] = {"label": "Descripción<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_mod_"][iNumLinha] = "id_mod_" + iNumLinha;
    ajax_field_mult["desc_mod_"][iNumLinha] = "desc_mod_" + iNumLinha;
    ajax_field_id["id_mod_" + iNumLinha] = new Array("hidden_field_label_id_mod_", "hidden_field_data_id_mod_" + iNumLinha);
    ajax_field_id["desc_mod_" + iNumLinha] = new Array("hidden_field_label_desc_mod_", "hidden_field_data_desc_mod_" + iNumLinha);
    ajax_error_count["id_mod_" + iNumLinha] = "off";
    ajax_error_count["desc_mod_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_mod_" + iNumLinha] = "on";
    ajax_read_only["desc_mod_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_mod_" + iNumLinha] = "on";
    ajax_read_only["desc_mod_" + iNumLinha] = "on";
<?php
}
?>
  }
  ...
  {
    ajax_error_list["id_mod_" + iNumLinha] = null;
    ajax_error_list["desc_mod_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["id_mod_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["id_mod_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["id_mod_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["id_mod_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["id_mod_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["desc_mod_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["desc_mod_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["desc_mod_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["desc_mod_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["desc_mod_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['id_mod_'])) ? $this->nmgp_cmp_readonly['id_mod_'] : 'on';
?>
    scAjaxFieldRead("id_mod_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['desc_mod_'])) ? $this->nmgp_cmp_readonly['desc_mod_'] : 'off';
?>
    scAjaxFieldRead("desc_mod_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_mod_" + iSeq, "on");
    scAjaxFieldRead("desc_mod_" + iSeq, "on");
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_mod_" + iRow] || "on" == ajax_error_count["desc_mod_" + iRow]))
    {
      ...
      if (document.getElementById("hidden_field_data_id_mod_" + iRow))
        document.getElementById("hidden_field_data_id_mod_" + iRow).className = "scFormErrorLine";
      if (document.getElementById("hidden_field_data_desc_mod_" + iRow))
        document.getElementById("hidden_field_data_desc_mod_" + iRow).className = "scFormErrorLine";
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_mod_" + iRow] && "off" == ajax_error_count["desc_mod_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_mod_" + iRow] = "off";
        ajax_error_count["desc_mod_" + iRow] = "off";
      }
      ...
      if (document.getElementById("hidden_field_data_id_mod_" + iRow))
        document.getElementById("hidden_field_data_id_mod_" + iRow).className = sCssLine;
      if (document.getElementById("hidden_field_data_desc_mod_" + iRow))
        document.getElementById("hidden_field_data_desc_mod_" + iRow).className = sCssLine;
    }
  }
