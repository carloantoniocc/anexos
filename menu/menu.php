...
else
{
    ...
    $_SESSION['scriptcase']['menu']['glo_nm_perfil']    = "anexos_prod";
...
$str_button = (isset($_SESSION['scriptcase']['str_button_all'])) ? $_SESSION['scriptcase']['str_button_all'] : "misbotones";
...
$this->str_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "propio/propio";
$nm_tst_protect = "93279e3308bdbbeed946fc965017f67a";
if ((isset($_SESSION['nm_session']['user']['sec']['pass']) && $_SESSION['nm_session']['user']['sec']['pass'] == "N") || (isset($NMSegok) && $NMSegok))
{ }
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
    ...
    <HTML>
     ...
     <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
      ...
      <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->str_schema_all ?>_menuH.css" /> 
     ...
     <body>
      <table align="center" class="scMenuHTable">
      <tr>
      <td align="middle" class="scMenuHItem">
                 <?php echo $this->Nm_lang['lang_errm_type_pswd']; ?>
             </td>
         </tr>
         <tr>
             <td align="middle">
                 <form name="Fsenha" method="post" action="menu.php">
<?php
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_modelos") . "/form_modelos_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_modelos']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_modelos'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_mant_usuarios") . "/form_mant_usuarios_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_mant_usuarios']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_mant_usuarios'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
$sc_teste_seg = file($path_apls . $this->tab_grupo[0] . SC_dir_app_name("form_usuarios_1") . "/form_usuarios_1_ini.txt");
if ((!isset($sc_teste_seg[3]) || trim($sc_teste_seg[3]) == "NAO") || (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N")) 
{
    if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_usuarios_1']))
    {
        $_SESSION['scriptcase']['sc_apl_seg']['form_usuarios_1'] = "on";
    }
}
if (isset($_SESSION['nm_session']['user']['sec']['flag']) && $_SESSION['nm_session']['user']['sec']['flag'] == "N") 
{ 
...
if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($nm_var_lab[5]))
{
 ...
 $nm_var_lab[6] = "Actualizaci�n de Usuarios";
...
$menu_menuData['data'] .= "item_2|.|" . $nm_var_lab[0] . "||" . $nm_var_hint[0] . "||_self|\n";
...
{
    $menu_menuData['data'] .= "item_3|..|" . $nm_var_lab[1] . "|menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=form_Departamentos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[1] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_3|..|" . $nm_var_lab[1] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_estado']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_estado']) == "on")
{
    $menu_menuData['data'] .= "item_4|..|" . $nm_var_lab[2] . "|menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=form_estado&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[2] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_4|..|" . $nm_var_lab[2] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_modelos']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_modelos']) == "on")
{
    $menu_menuData['data'] .= "item_7|..|" . $nm_var_lab[3] . "|menu_form_php.php?sc_item_menu=item_7&sc_apl_menu=form_modelos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[3] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
...
{
    $menu_menuData['data'] .= "item_8|..|" . $nm_var_lab[4] . "|menu_form_php.php?sc_item_menu=item_8&sc_apl_menu=form_categorias&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[4] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_8|..|" . $nm_var_lab[4] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_mant_usuarios']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_mant_usuarios']) == "on")
{
    $menu_menuData['data'] .= "item_6|..|" . $nm_var_lab[5] . "|menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=form_mant_usuarios&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[5] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_6|..|" . $nm_var_lab[5] . "||||_self|disabled\n";
}
if (isset($_SESSION['scriptcase']['sc_apl_seg']['form_usuarios_1']) && strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_usuarios_1']) == "on")
{
    $menu_menuData['data'] .= "item_1|.|" . $nm_var_lab[6] . "|menu_form_php.php?sc_item_menu=item_1&sc_apl_menu=form_usuarios_1&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "|" . $nm_var_hint[6] . "||" . $this->menu_target('_self') . "|" . "\n";
}
else
{
    $menu_menuData['data'] .= "item_1|.|" . $nm_var_lab[6] . "||||_self|disabled\n";
}
$menu_menuData['data'] .= "item_5|.|" . $nm_var_lab[7] . "||" . $nm_var_hint[7] . "||_self|\n";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_3&sc_apl_menu=form_Departamentos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_Departamentos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_Departamentos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_4&sc_apl_menu=form_estado&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_estado']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_estado']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_7&sc_apl_menu=form_modelos&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_modelos']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_modelos']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_8&sc_apl_menu=form_categorias&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_categorias']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_categorias']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_6&sc_apl_menu=form_mant_usuarios&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_mant_usuarios']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_mant_usuarios']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
...
$str_disabled = "N";
$str_link = "menu_form_php.php?sc_item_menu=item_1&sc_apl_menu=form_usuarios_1&sc_apl_link=" . urlencode($menu_menuData['url']['link']) . "&sc_usa_grupo=" . $_SESSION['scriptcase']['menu']['glo_nm_usa_grupo'] . "";
if (!isset($_SESSION['scriptcase']['sc_apl_seg']['form_usuarios_1']) || strtolower($_SESSION['scriptcase']['sc_apl_seg']['form_usuarios_1']) != "on")
{
    $str_link = "#";
    $str_disabled = "Y";
