  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_foto_ver" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate foto
  function do_ajax_form_foto_ver_validate_foto()
  {
    var nomeCampo_foto = "foto";
    var var_foto = scAjaxGetFieldText(nomeCampo_foto);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_foto_ver_validate_foto(var_foto, var_script_case_init, do_ajax_form_foto_ver_validate_foto_cb);
  } // do_ajax_form_foto_ver_validate_foto

  function do_ajax_form_foto_ver_validate_foto_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_foto_ver_validate_foto_cb
  // ---------- Form
  function do_ajax_form_foto_ver_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_foto_ver_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_foto_ver_submit_form(var_foto, var_foto_ul_name, var_foto_ul_type, var_foto_salva, var_foto_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_foto_ver_submit_form_cb);
  } // do_ajax_form_foto_ver_submit_form

  function do_ajax_form_foto_ver_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_foto_ver_submit_form_cb

  var scStatusDetail = {};

  function do_ajax_form_foto_ver_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_foto_ver_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_foto_ver_navigate_form_cb);
  } // do_ajax_form_foto_ver_navigate_form

  function do_ajax_form_foto_ver_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
{
?>
    do_ajax_form_foto_ver_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_foto_ver_navigate_form_cb
  function sc_hide_form_foto_ver_form()
  {
    for (var block_id in ajax_block_id) {
      $("#div_" + ajax_block_id[block_id]).hide();
    }
  } // sc_hide_form_foto_ver_form
