...
<?php
include_once("form_foto_ver_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_foto_ver_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto_ver']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto_ver']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto_ver']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto_ver']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_foto_ver']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto_ver']['recarga'];
}
?>
...
<?php
 include_once("form_foto_ver_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto_ver']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto_ver']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_foto_ver'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_foto_ver'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto_ver']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto_ver']['run_iframe'] != "R" && (!$this->aba_iframe || $this->is_calendar_app) && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (!$this->Embutida_call) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto_ver']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto_ver']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_foto_ver']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_foto_ver']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_foto_line" id="hidden_field_data_foto" style="<?php echo $sStyleHidden_foto; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_foto_line" style="padding: 0px">
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_foto_ver']['masterValue']))
{
?>
...
?>
<script>
 parent.scAjaxDetailStatus("form_foto_ver");
 parent.scAjaxDetailHeight("form_foto_ver", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
}
