...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id_
  function do_ajax_form_Departamentos_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Departamentos_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_Departamentos_validate_id__cb);
  } // do_ajax_form_Departamentos_validate_id_

  function do_ajax_form_Departamentos_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Departamentos_validate_id__cb

  // ---------- Validate descripcion_
  function do_ajax_form_Departamentos_validate_descripcion_(iNumLinha)
  {
    var nomeCampo_descripcion_ = "descripcion_" + iNumLinha;
    var var_descripcion_ = scAjaxGetFieldText(nomeCampo_descripcion_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Departamentos_validate_descripcion_(var_descripcion_, iNumLinha, var_script_case_init, do_ajax_form_Departamentos_validate_descripcion__cb);
  } // do_ajax_form_Departamentos_validate_descripcion_

  function do_ajax_form_Departamentos_validate_descripcion__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_Departamentos_validate_descripcion__cb
  ...
  function do_ajax_form_Departamentos_backup_line(iNumLinha)
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_Departamentos_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_Departamentos_backup_line_cb);
...
?>
  ...
  function do_ajax_form_Departamentos_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_Departamentos_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_Departamentos_table_refresh_cb);
...
?>
    x_ajax_form_Departamentos_submit_form(var_id_, var_descripcion_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_Departamentos_submit_form_cb);
...
?>
  ...
  function do_ajax_form_Departamentos_navigate_form()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_Departamentos_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_Departamentos_navigate_form_cb);
