...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_Departamentos']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Departamentos']['mostra_cab'] != "N"))
  {
?>
<tr><td>
<style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFormHeaderFont"><span><?php echo "Departamentos" ?></span></td>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bnovo", "do_ajax_form_Departamentos_add_new_line(); return false;", "do_ajax_form_Departamentos_add_new_line(); return false;", "sc_b_new_t", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "");?>
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Departamentos']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_Departamentos']['run_iframe'] != "R") && (!$this->Embutida_call)) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Departamentos']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_Departamentos']['run_iframe'] == "R") && (!$this->Embutida_call)) {
...
{ 
   ...
   foreach ($this->form_vert_form_Departamentos as $sc_seq_vert => $sc_lixo)
   {
       ...
       elseif ($Line_Add)
       {
        ...
        $this->id_ = $this->form_vert_form_Departamentos[$sc_seq_vert]['id_']; 
       $id_ = $this->id_; 
       $sStyleHidden_id_ = '';
       ...
       $this->descripcion_ = $this->form_vert_form_Departamentos[$sc_seq_vert]['descripcion_']; 
